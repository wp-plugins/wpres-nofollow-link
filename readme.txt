...
* russian / pоссия (ru_RU) - Thanks to Flector

= Support =
If you have Questions please send a mail to: [support@wpres.net](mailto:support@wpres.net)
...
= 1.0.0 (2015-05-12) =
* beta is over ;-)
* NEW: Added L10n Russian - Thanks to Flector
* CODE: Some internal improvements

= 0.9.1 (2015-04-30) =
* BUGFIX: Removed a space in source to avoid a error in activating the plugin

= 0.9.0 (2015-04-30) =
* NEW: Added i18n
* NEW: Added L10n german and english
* CODE: Small code improvements
